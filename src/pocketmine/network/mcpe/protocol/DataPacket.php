...
abstract class DataPacket extends NetworkBinaryStream{
	...
	/**
	 * Performs handling for this packet. Usually you'll want an appropriate method in the NetworkHandler for this.
	 *
	 * This method returns a bool to indicate whether the packet was handled or not.
	 * Network sessions may have multiple handlers installed. If the packet was unhandled by all handlers, a debug
	 * message will be logged with a hexdump of the packet.
	 *
	 * Typically this method returns the return value of the handler in the supplied NetworkHandler. See other packets
